        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    if (_result4 != null) {
                        reply.writeInt(1);
                        _result4.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                ...
                case 7:
                    ...
                    if (_result7 != null) {
                        reply.writeInt(1);
                        _result7.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case 8:
                    ...
                    if (_result8 != null) {
                        reply.writeInt(1);
                        _result8.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_getPurchaseHistory /*9*/:
                    ...
                    if (_result9 != null) {
                        reply.writeInt(1);
                        _result9.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_isBillingSupportedExtraParams /*10*/:
                    ...
                    return true;
                case TRANSACTION_getPurchasesExtraParams /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    if (_result11 != null) {
                        reply.writeInt(1);
                        _result11.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_consumePurchaseExtraParams /*12*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    if (_result12 != null) {
                        reply.writeInt(1);
                        _result12.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_getSubscriptionManagementIntent /*801*/:
                    ...
                    if (_result13 != null) {
                        reply.writeInt(1);
                        _result13.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_getSkuDetailsExtraParams /*901*/:
                    ...
                    if (_result14 != null) {
                        reply.writeInt(1);
                        _result14.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_acknowledgePurchaseExtraParams /*902*/:
                    ...
                    if (_result15 != null) {
                        reply.writeInt(1);
                        _result15.writeToParcel(reply, Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
        ...
        private static class Proxy implements IInAppBillingService {
            ...
            public int isBillingSupportedExtraParams(int apiVersion, String packageName, String type, Bundle extraParams) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_isBillingSupportedExtraParams, _data, _reply, 0);
                    _reply.readException();
                    return _reply.readInt();
                } finally {
                    _reply.recycle();
            ...
            public Bundle getPurchasesExtraParams(int apiVersion, String packageName, String type, String continuationToken, Bundle extraParams) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getPurchasesExtraParams, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (Bundle) Bundle.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public Bundle consumePurchaseExtraParams(int apiVersion, String packageName, String purchaseToken, Bundle extraParams) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_consumePurchaseExtraParams, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (Bundle) Bundle.CREATOR.createFromParcel(_reply);
                    } else {
